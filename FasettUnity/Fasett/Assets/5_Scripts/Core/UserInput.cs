...
namespace Fasett {
    public class UserInput : MonoBehaviour {
        ...
        public static Action OnUserSaidExportCalibration;
        ...
        private const string EXPORT_CALIBRATION_PHRASE = "export calibration";
        ...
        public void Setup(Core core) {
            ...
            _keywordRecognizer = new KeywordRecognizer(new string[] { NEXT_EFFECT_PHRASE, CALIBRATE_ALL_EFFECTS_PHRASE, CALIBRATE_CLOSEST_EFFECT_PHRASE, EXHIBITION_SETUP_PHRASE, DEMO_MODE_PHRASE, OK_PHRASE, INFORMATION_PHRASE, DEBUG_PHRASE, WIREFRAME_PHRASE, EXPORT_CALIBRATION_PHRASE });
        ...
        private void PhraseRecognized(PhraseRecognizedEventArgs eventArgs) {
            ...
            switch(eventArgs.text) {
                ...
                case WIREFRAME_PHRASE:
                    ...
                    break;
                case EXPORT_CALIBRATION_PHRASE:
                    action = OnUserSaidExportCalibration;
                    break;
            }
            if (action != null) {
                action();
