...
////// Emissive:
                ...
                float3 emissive = (_CellRamp_var.rgb*(_Tint.rgb*i.vertexColor.rgb)*((_Amplitude*sin((6.28318530718*_Frequency*node_5497.g)))+2.0)*(node_9788.rgb*node_5006.rgb*2.0));
