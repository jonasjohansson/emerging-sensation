...
////// Emissive:
                ...
                float node_4209 = dot(node_9942.rgb,float3(0.3,0.59,0.11));
                float3 emissive = ((node_7521.rgb+node_6979.rgb)*node_382.rgb*_TintColor.rgb*2.0*(node_4209+1.0));
